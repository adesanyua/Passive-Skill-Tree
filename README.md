...
Этот гайд относится к [генератору навыков](examples/kubejs/server_scripts/main.js) и текущему порту
...
Для установки скопируй папки `server_scripts` и `assets` из
[`examples/kubejs`](examples/kubejs) в папку `kubejs` своей сборки.
Подробности установки и описание трёх веток — в [инструкции](examples/kubejs/README.md).
