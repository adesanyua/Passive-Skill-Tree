...
public enum IronsSpellbooksCompat {
    ...
    public static final DeferredHolder<SkillBonus.Serializer, SkillBonus.Serializer> GRANT_SPELL_BONUS = PSTSkillBonuses.REGISTRY.register("grant_spell", GrantSpellSkillBonus.Serializer::new);
    public static final DeferredHolder<SkillBonus.Serializer, SkillBonus.Serializer> SPELL_LEVEL_BONUS = PSTSkillBonuses.REGISTRY.register("spell_level", SpellLevelSkillBonus.Serializer::new);
    public static final DeferredHolder<FloatFunction.Serializer, FloatFunction.Serializer> MANA_LEVEL_FUNCTION = PSTFloatFunctions.REGISTRY.register("mana_level", ManaLevelFunction.Serializer::new);
