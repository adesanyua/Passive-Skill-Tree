...
public enum CuriosCompatibility {
    ...
    public static final DeferredHolder<SkillBonus.Serializer, SkillBonus.Serializer> CURIO_SLOTS_BONUS = PSTSkillBonuses.REGISTRY.register("curio_slots", CurioSlotsBonus.Serializer::new);
