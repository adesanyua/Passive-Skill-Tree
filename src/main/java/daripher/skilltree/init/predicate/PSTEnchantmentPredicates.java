...
public class PSTEnchantmentPredicates {
    ...
    public static final DeferredHolder<EnchantmentCondition.Serializer, EnchantmentCondition.Serializer> NONE = REGISTRY.register("none", NoneEnchantmentCondition.Serializer::new);
    public static final DeferredHolder<EnchantmentCondition.Serializer, EnchantmentCondition.Serializer> ARMOR = REGISTRY.register("armor", ArmorEnchantmentCondition.Serializer::new);
    public static final DeferredHolder<EnchantmentCondition.Serializer, EnchantmentCondition.Serializer> WEAPON = REGISTRY.register("weapon", WeaponEnchantmentCondition.Serializer::new);

    public static List<EnchantmentCondition> conditionsList() {
        return PSTRegistries.ENCHANTMENT_CONDITIONS.stream().map(EnchantmentCondition.Serializer::createDefaultInstance)
                .toList();
    }

    public static String getName(EnchantmentCondition condition) {
        ResourceLocation id = PSTRegistries.ENCHANTMENT_CONDITIONS.getKey(condition.getSerializer());
