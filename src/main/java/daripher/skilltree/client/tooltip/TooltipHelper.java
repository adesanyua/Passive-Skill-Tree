...
public class TooltipHelper {
    ...
    public static Component getRecipeTooltip(ResourceLocation recipeId) {
        ...
        List<AbstractWorkbenchRecipe> recipes = recipeManager.getAllRecipesFor(PSTRecipeTypes.WORKBENCH.get()).stream().map(net.minecraft.world.item.crafting.RecipeHolder::value).toList();
