...
public class WorkbenchMenu extends AbstractContainerMenu {
    ...
    private List<AbstractWorkbenchRecipe> getAllWorkbenchRecipes() {
        ...
        WORKBENCH_RECIPE_CACHE.addAll(level.getRecipeManager().getAllRecipesFor(PSTRecipeTypes.WORKBENCH.get()).stream()
                .map(holder -> holder.value().bindId(holder.id())).toList());
