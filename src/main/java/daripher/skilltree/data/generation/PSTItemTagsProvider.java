...
public class PSTItemTagsProvider extends ItemTagsProvider {
    public static final ResourceLocation KNIVES = ResourceLocation.fromNamespaceAndPath("c", "tools/knife");
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider) {
        ...
        tag(PSTTags.Items.MELEE_WEAPON).addTags(ItemTags.SWORDS, ItemTags.AXES).add(Items.TRIDENT);
        tag(PSTTags.Items.RANGED_WEAPON).add(Items.BOW, Items.CROSSBOW);
